...
theta2 = (np.asarray([[43.4224, 50.5387, 74.2585, 90.0771],
		[43.7313, 50.9318, 74.8963, 90.923],
		[44.0595, 51.3155, 75.501, 91.696],
		[44.3206, 51.6249, 75.9962, 92.365],
		[44.5913, 51.9418, 76.4947, 93.0779]])/180) * np.pi
theta2_er = np.asarray([[0.0016, 0.0035, 0.006, 0.0084],
		     [0.002, 0.0047, 0.0082, 0.013,],
		     [0.0024, 0.0057, 0.011,  0.016],
		     [0.002, 0.0049, 0.0095,  0.014], 
             [0.0015, 0.0032, 0.0067, 0.009]])
theta = theta2 / 2
