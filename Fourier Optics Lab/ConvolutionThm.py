...
xmax = np.empty(2) 
ymax = np.empty(2) 
ymax[0] = np.amin(imdata[1800:1900])
xmax[0] = np.argmin(imdata[1800:1900]) - 2015+1800
ymax[1] = np.amin(imdata[2000:2200])
xmax[1] = np.argmin(imdata[2000:2200]) - 2015+2000

=======
>>>>>>> da963835ff93d240585ad613d923761ed2e6e8e3
